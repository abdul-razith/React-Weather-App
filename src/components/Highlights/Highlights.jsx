...
export const Highlights = ({ airData, highlightsProps }) => {
  ...
  // Time convert
  function convertUnixToLocalTime(unixTime, offset) {
    const date = new Date(unixTime * 1000); // Convert Unix time to milliseconds
    const utcTime = date.getTime() + date.getTimezoneOffset() * 60000; // Adjust for local time
    const localTime = new Date(utcTime + offset * 1000); // Adjust for the timezone offset
  ...
  const timezoneOffset = highlightsProps.timezone;

  // Convert sunrise and sunset times
  const sunrise = convertUnixToLocalTime(highlightsProps.sunrise,timezoneOffset);
  const sunset = convertUnixToLocalTime(highlightsProps.sunset, timezoneOffset);
          ...
          <div className="air-quality">
            <div className="aqi">
              ...
              <button style={{ backgroundColor: btnColor }}>
                {air_quality[airData.list[0].main.aqi]}
              </button>
            </div>
            <div className="gas">
            ...
            <div className="pressure">
              ...
              <div className="pressure-data">
                {highlightsProps.pressure >= 1013 ? (
                  <>
                    <img
                      src={other_icons.pressure_high_icon}
                      alt="High Pressure"
                      width={80}
                      height={70}
                    />
                  ...
                  <>
                    <img
                      src={other_icons.pressure_low_icon}
                      alt="Low Pressure"
                      width={80}
                      height={70}
                    />
          ...
          <div className="right">
            ...
            <div className="feels-like">
              ...
              <div className="feels-like-data">
                <img
                  src={other_icons.thermometer_celsius_icon}
                  alt=""
                  width={80}
                  height={70}
                />
